...
fun CalorieScreen() {
    ...
    Column(
        ...
        GenderChoices(male = male, setGenderChoices = { male = it })
...
@Composable
fun GenderChoices(male: Boolean, setGenderChoices: (Boolean) -> Unit) {

    Column(Modifier.selectableGroup()) {
        Row(verticalAlignment = Alignment.CenterVertically) {
            RadioButton(selected = male,
                onClick = { setGenderChoices(true) }
            )
            Text(text = "Male")
        }
        Row(verticalAlignment = Alignment.CenterVertically) {
            RadioButton(selected = !male,
                onClick = { setGenderChoices(false) }
            )
            Text(text = "Female")
        }
    }
